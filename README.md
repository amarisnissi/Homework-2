...
1. a + b
  a. Using the variables from part (a), a + b gives a 2x2 array adding each element from the array a with that of the array b so that a + b = [1,0;2,1] + [-1,0;2,1] = [0,0;4,2] 
2. a .* b
3. a * b
4. a * c
5. a + c
